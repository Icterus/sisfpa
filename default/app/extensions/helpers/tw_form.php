...
class TwForm extends Form
{
    ...
    public static function cmbMeses($field, $attrs=NULL, $value=NULL)
    {
        $meses = array(
            '01' => 'Enero',
            '02' => 'Febrero',
    ...
    public static function cmbPaises($field, $attrs=NULL, $value=NULL)
    {
        ...
        foreach ($paises as $k) {
            ...
            $options .= '>' . htmlspecialchars($k, ENT_COMPAT, APP_CHARSET) . '</option>';
        }
